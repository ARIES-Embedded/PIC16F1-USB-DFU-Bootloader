...
#define BD_ADDR 0x2000 //there are 8 endpoint buffer descriptors, each 4 byte -> 32 bytes, starting from 0x2000 -> 0x201F
#define BUFFER_ADDR 0x2020 //this was originally 0x2080
#else
